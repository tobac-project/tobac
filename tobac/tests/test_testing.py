...
def test_make_feature_blob():
    ...
    out_blob = tbtest.make_feature_blob(np.zeros((10,10)), h1_loc=5, h2_loc=5, 
        h1_size = 2, h2_size= 2, shape='rectangle', amplitude= 1)
    ...
    h1_size = 2, h2_size= 4, shape='rectangle', amplitude= 1)
...
def test_generate_single_feature():
    ...
    expected_df = pd.DataFrame.from_dict([
        {'hdim_1': 1, 'hdim_2': 1, 'frame': 0, 'time': datetime.datetime(2022, 1, 1,0,0), 'feature':1}
    ])
    ...
    expected_df = pd.DataFrame.from_dict([
        {'hdim_1': 1, 'hdim_2': 1, 'frame': 0, 'time': datetime.datetime(2022, 1, 1,0,0), 'feature':1},
        {'hdim_1': 2, 'hdim_2': 2, 'frame': 1, 'time': datetime.datetime(2022, 1, 1,0,5), 'feature':2},
        {'hdim_1': 3, 'hdim_2': 3, 'frame': 2, 'time': datetime.datetime(2022, 1, 1,0,10), 'feature':3},
        {'hdim_1': 4, 'hdim_2': 4, 'frame': 3, 'time': datetime.datetime(2022, 1, 1,0,15), 'feature':4},
    ])

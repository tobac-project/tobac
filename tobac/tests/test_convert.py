...
def test_xarray_input():
    ...
    feature_detection_xarray = tobac.utils.xarray_to_iris(tobac.feature_detection.feature_detection_multithreshold)
    ...
    mask_xarray, features_xarray = segmentation_xarray(features_xarray, data_xarray, dxy_xarray, 1.0)
    ...
    track_xarray = tracking_xarray(features_xarray, data_xarray, dt_xarray, dxy_xarray, v_max=100.0)

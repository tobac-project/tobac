...
from .utils import mask_cell,mask_cell_surface,mask_cube_cell
...
#       Mask_cell_surface_i=mask_cell_surface(Mask_w_i,cell,masked=False,z_coord='model_level_number')
        ...
        for aggregator_name in cubes_profile.keys():
            ...
            savefile=os.path.join(output_path,output_name,aggregator_name,output_name+'_'+ aggregator_name+'_'+str(int(cell))+'.nc')
